...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("p1 -> p1 = " + p1.slopeTo(p1));
        System.out.println("p1 -> p2 = " + p1.slopeTo(p2));
        System.out.println("p2 -> p3 = " + p2.slopeTo(p3));
        System.out.println("p1 -> p3 = " + p1.slopeTo(p3));
        System.out.println("p2 -> p4 = " + p2.slopeTo(p4));
        ...
        Point extremePoint = new Point(32767, 32767);
